    ...
    <main className="min-h-dvh bg-stone-50 text-stone-900 ">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { name: "West Africa", count: "120+ Recipes", img: "/africa.jpg", desc: "Jollof, Egusi & Suya" },
            { name: "East Africa", count: "85+ Recipes", img: "/dish.jpg", desc: "Injera, Nyama Choma" },
            { name: "North Africa", count: "90+ Recipes", img: "/food.jpg", desc: "Tagine, Couscous" },
            { name: "South & Central", count: "75+ Recipes", img: "/enjoy.jpg", desc: "Bobotie, Bunny Chow" },
          ].map((cat, idx) => (
            <div 
              key={idx} 
