...
export default async function AccountAuth() {
      ...
      <section className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-20 bg-gray-50 lg:bg-white relative">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* GOOGLE AUTH BUTTON (Converted to a link or server action trigger) */}
            <form
              action={async () => {
                "use server"
                await signIn("google")
            ...
            >
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl border-2 border-gray-200 bg-white text-gray-700 font-semibold text-lg hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm"
              >
                <FcGoogle size={24} />
                Sign in with Google
              </button>
